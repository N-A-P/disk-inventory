...
#ifndef OMNIAPPKIT_SWIFT_H
#define OMNIAPPKIT_SWIFT_H
...
typedef SWIFT_ENUM_NAMED(NSInteger, OACardViewShadowStyle, "CardViewShadowStyle", open) {
...
SWIFT_CLASS("_TtC10OmniAppKit15OALinkTextField")
@interface OALinkTextField : NSTextField
