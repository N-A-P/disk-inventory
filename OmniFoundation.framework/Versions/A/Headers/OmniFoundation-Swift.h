...
#ifndef OMNIFOUNDATION_SWIFT_H
#define OMNIFOUNDATION_SWIFT_H
...
- (void)addWithResourceType:(NSString * _Nonnull)resourceType withPredicate:(id <OFResourceTypePredicate> _Nonnull)predicate;
...
@class OFResourceLocationContents;
...
@property (nonatomic, readonly, copy) NSString * _Nullable folderURLContainerDisplayName;
...
- (void)invalidate;
- (OFResourceLocationContents * _Nullable)resourceContentsWithType:(NSString * _Nonnull)type SWIFT_WARN_UNUSED_RESULT;
...
@interface OFTypeIdentifier : NSObject
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull pathExtensions;
@property (nonatomic, readonly, copy) NSString * _Nonnull displayName;
- (nonnull instancetype)initWithRawType:(NSString * _Nonnull)rawType;
@property (nonatomic, readonly) NSUInteger hash;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) OFTypeIdentifier * _Nonnull plainText;)
+ (OFTypeIdentifier * _Nonnull)plainText SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithFileTypes:(NSArray<NSString *> * _Nonnull)fileTypes OBJC_DESIGNATED_INITIALIZER;
